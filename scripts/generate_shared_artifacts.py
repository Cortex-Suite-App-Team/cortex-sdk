...
export const DEFAULT_SESSION_OPEN_TIMEOUT_MS = {constants["DEFAULT_SESSION_OPEN_TIMEOUT_MS"]};
...
DEFAULT_SESSION_OPEN_TIMEOUT_MS: int = {constants["DEFAULT_SESSION_OPEN_TIMEOUT_MS"]}
